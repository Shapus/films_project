...
?>
			<form class="form container w-50 mt-5 flex-column align-items-center justify-content-center text-center" role="form" method="POST" action="registrationAnswer">
                ...
                <div class="row mb-3 align-items-center">
                    <div class="col"></div>
                        <h2 class="col-8 mb-5" style="color:red; font-size:0.9rem;"><?php echo $control[1][4] ?></h2>
                    <div class="col"></div>
                </div>
                <div class="row mb-3 align-items-center">
                    <div class="col"></div>
                    <input class="col-8 w-50 p-2" type="text" id="name" name="name" placeholder="Имя пользователя" required>
                    <label class="col p-0 m-0" style="color:red; font-size:0.9rem;"><?php echo $control[1][0] ?></label>
                </div>
                <div class="row mb-3 align-items-center">
                    <div class="col"></div>
                    <input class="col-8 w-50 p-2" type="email" id="email" name="email" placeholder="E-mail" required>
                    <label class="col p-0 m-0" style="color:red; font-size:0.9rem;"><?php echo $control[1][1] ?></label>
                </div>
                <div class="row mb-3 align-items-center">
                    <div class="col"></div>
                    <input class="col-8 w-50 p-2" type="password" id="password" name="password" placeholder="Пароль" required>  
                    <label class="col p-0 m-0" style="color:red; font-size:0.9rem;"><?php echo $control[1][2] ?></label>
                </div>
                <div class="row mb-3 align-items-center">
                    <div class="col"></div>
                    <input class="col-8 w-50 p-2" type="password" id="confirm" name="confirm" placeholder="Повторите пароль" required>
                    <label class="col p-0 m-0" style="color:red; font-size:0.9rem;"><?php echo $control[1][3] ?></label>
                </div>
